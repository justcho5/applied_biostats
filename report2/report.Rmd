...
In order to test for the independence of the features, Chi-squared (??2) test was performed between categorial features. In addition, in order to understand whether there is a relationship between the above clinicopathologic features and CLNM, univariate logistic and binary logistic regression were performed, where a p-value of < 0.05 was considered statistically significant.
